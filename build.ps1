...
Write-Host "`n[3/3] Compiling Android App Bundles (AAB) for GMS and HMS..." -ForegroundColor Cyan
...
Write-Host "Generated AAB (App Bundle) files are located at:" -ForegroundColor Yellow
